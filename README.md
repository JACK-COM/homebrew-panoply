...
|---|---|---|---|
| <picture><source media="(prefers-color-scheme: dark)" srcset="docs/marks/locket-dark.svg"><img src="docs/marks/locket-light.svg" alt="Locket" width="40"></picture> | [Locket](https://github.com/JACK-COM/locket) | Remember who you are: keeps an agent's memory from holding the same fact twice, and counts the tokens your agents spend. | `brew install locket` |
...
New here? [The guides](docs/README.md) explain which piece you need, how to set each one up, and how to make it yours.
